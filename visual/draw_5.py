...
# mask PTM
group1_1 = [92.77, 94.04, 73.4, 70.64]  # mask PTM1
group1_std_1 = [2.37, 2.98, 4.69, 4.64]  # mask PTM1

group2_2 = [92.77, 95.96, 70.85, 72.77]  # mask PTM2
group2_std_2 = [1.70, 1.49, 3.81, 4.13]  # mask PTM2
#
group3_3 = [91.70, 94.26, 69.79, 74.47]  # mask PTM3
group3_std_3 = [2.60, 3.30, 3.90, 4.36]  # mask PTM3

group4_4 = [93.19, 95.11, 67.23, 74.04]  # mask PTM4
group4_std_4 = [1.28, 1.36, 4.38, 6.58]  # mask PTM4

group5_5 = [91.91, 94.26, 69.57, 74.68]  # mask PTM4
group5_std_5 = [1.85, 2.70, 2.70, 6.20]  # mask PTM4
...
colors2 = ['#76A0AD', '#597C8B', '#DABE84', '#D9BDC3', '#C4D0CC']  # green /red
# x轴上的位置
num_groups = 5  # 每个类别的柱子数量
...
group1 = group1_1
group1_std = group1_std_1
group2 = group2_2
group2_std = group2_std_2
group3 = group3_3
group3_std = group3_std_3
group4 = group4_4
group4_std = group4_std_4
group5 = group5_5
group5_std = group5_std_5
# 绘制两组数据的柱状图
rects1 = ax.bar(x + 0 * width, group1, width * 0.9, yerr=group1_std, label=f'Masked PTM-1', color=colors[3], capsize=5)
rects2 = ax.bar(x + 1 * width, group2, width * 0.9, yerr=group2_std, label=f'Masked PTM-2', color=colors[4], capsize=5)
rects3 = ax.bar(x + 2 * width, group3, width * 0.9, yerr=group3_std, label=f'Masked PTM-3', color=colors[2], capsize=5)
rects4 = ax.bar(x + 3 * width, group4, width * 0.9, yerr=group4_std, label=f'Masked PTM-4', color=colors[1], capsize=5)
rects5 = ax.bar(x + 4 * width, group5, width * 0.9, yerr=group5_std, label=f'MoME', color=colors2[3], capsize=5)

# 添加标签和标题
ax.set_xlabel('Domains')
ax.set_ylabel('ACC')
ax.set_title(f'MoME vs Masked PTMs')
