...
def GIN5_64(args):
    return GIN(num_layers=5, num_mlp_layers=2, input_dim=args.dim_feat, hidden_dim=64,
               output_dim=args.gcls, final_dropout=0.5, learn_eps=False, graph_pooling_type='sum',
               neighbor_pooling_type='sum')


def GIN5_32(args):
    return GIN(num_layers=5, num_mlp_layers=2, input_dim=args.dim_feat, hidden_dim=32,
               output_dim=args.gcls, final_dropout=0.5, learn_eps=False, graph_pooling_type='sum',
               neighbor_pooling_type='sum')


def GIN3_64(args):
    return GIN(num_layers=3, num_mlp_layers=2, input_dim=args.dim_feat, hidden_dim=64,
               output_dim=args.gcls, final_dropout=0.5, learn_eps=False, graph_pooling_type='sum',
               neighbor_pooling_type='sum')


def GIN3_32(args):
    return GIN(num_layers=3, num_mlp_layers=2, input_dim=args.dim_feat, hidden_dim=32,
               output_dim=args.gcls, final_dropout=0.5, learn_eps=False, graph_pooling_type='sum',
               neighbor_pooling_type='sum')


def GIN2_64(args):
    return GIN(num_layers=2, num_mlp_layers=2, input_dim=args.dim_feat, hidden_dim=64,
               output_dim=args.gcls, final_dropout=0.5, learn_eps=False, graph_pooling_type='sum',
               neighbor_pooling_type='sum')


def GIN2_32(args):
    return GIN(num_layers=2, num_mlp_layers=2, input_dim=args.dim_feat, hidden_dim=32,
               output_dim=args.gcls, final_dropout=0.5, learn_eps=False, graph_pooling_type='sum',
               neighbor_pooling_type='sum')